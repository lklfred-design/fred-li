...
(function () {
  var META = {
    en: {
      ...
      desc: 'Fred Li (李冠乐) is Managing Director & Head of University Ventures at Gobi Partners — among the most active venture capitalists, ecosystem builders and educators in the Greater Bay Area, teaching 100+ hours a year across six Hong Kong universities and investing in deep tech, Life Sciences and university spin-offs. Author of 李佛创投笔记 (Li Fo Venture Notes).',
      toggleLabel: '中文'
    },
    zh: {
      htmlLang: 'zh-CN',
  ...
  var T = [
    ...
    { s: '.hero-lede', en: 'Turning breakthrough university research into scalable ventures — investing, teaching and building the deep-tech and Life Sciences ecosystem across Hong Kong and the Greater Bay Area.', zh: '专注把突破性的大学科研成果转化为可规模化的公司——在香港与大湾区投资、授课，并构建深科技与生命科学创业生态。' },
    { s: '.hero-tags li:nth-of-type(1)', en: 'Deep Tech', zh: '深科技' },
    { s: '.hero-tags li:nth-of-type(2)', en: 'Life Sciences', zh: '生命科学' },
    ...
    { s: '.about-body p:nth-of-type(4)', en: 'He writes under the personal brand <strong>李佛创投笔记 (Li Fo Venture Notes)</strong>, sharing bilingual insights on Life Sciences, AI, deep tech and the Greater Bay Area startup ecosystem.', zh: '他以个人品牌<strong>《李佛创投笔记》（Li Fo Venture Notes）</strong>持续写作，以中英双语分享生命科学、AI、深科技与大湾区创业生态的观察。' },
    { s: '.about-side h3:nth-of-type(1)', en: 'Education', zh: '教育背景' },
    { s: '.about-side ul:nth-of-type(1) li:nth-of-type(1) .fact-label', en: 'MSc, Biotechnology', zh: '理学硕士（生物技术）' },
    { s: '.about-side ul:nth-of-type(1) li:nth-of-type(1) .fact-sub', en: 'Hong Kong University of Science and Technology (HKUST)', zh: '香港科技大学（HKUST）' },
    { s: '.about-side ul:nth-of-type(1) li:nth-of-type(2) .fact-label', en: 'BBA, Accounting &amp; Finance', zh: '工商管理学士（会计及财务）' },
    { s: '.about-side ul:nth-of-type(1) li:nth-of-type(2) .fact-sub', en: 'The University of Hong Kong (HKU)', zh: '香港大学（HKU）' },
    ...
    { s: '#focus .card:nth-of-type(2) h3', en: 'Life Sciences', zh: '生命科学' },
    ...
    { s: '.faq-list details:nth-of-type(3) p', en: 'Early-stage deep tech: university spin-offs, Life Sciences (biotech &amp; healthcare), AI and robotics, and greentech — primarily across Hong Kong and the Greater Bay Area.', zh: '早期深科技：大学衍生企业、生命科学（生物科技与医疗健康）、AI 与机器人、绿色科技——主要布局香港与大湾区。' },
    ...
    { s: '#carCap11', en: 'Panelist at RTHK&rsquo;s 《2025投資月論壇》 Investment Month Forum', zh: '香港电台《2025投资月论坛》讨论嘉宾' },
